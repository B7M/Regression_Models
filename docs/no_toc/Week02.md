...
# Plot the dataset
plot(X, Y, xlim = c(0, 5), ylim = c(0, 5), main = "Scatterplot with Random Points around 2.5, 2.5", 
     xlab = "X", ylab = "Y", pch = "+", col = "red", cex=1.75)
...
<img src="resources/images/Week02_files/figure-html/unnamed-chunk-21-1.png" width="672" />
...
<img src="resources/images/Week02_files/figure-html/unnamed-chunk-25-1.png" width="672" />
