...
The most up to date information on the course lecture notes will always be in the [Github repository](https://github.com/bcaffo/courses). Please issue pull requests so that we may improve the materials. Note my GitHub repo will generally be more up to date than the Data Science Specialization Repo.
